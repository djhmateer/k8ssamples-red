...
::call az mysql server create -l westeurope -g amysql -n davemysql -u dave -p SECRET --sku-name B_Gen5_1

call az mysql db create -g amysql -s davemysql -n ellenrotheraycouk
